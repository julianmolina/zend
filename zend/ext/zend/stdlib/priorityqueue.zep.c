...
ZEPHIR_INIT_CLASS(Zend_Stdlib_PriorityQueue) {

	ZEPHIR_REGISTER_CLASS(Zend\\Stdlib, PriorityQueue, zend, stdlib_priorityqueue, zend_stdlib_priorityqueue_method_entry, 0);

	/**
	 * Inner queue class to use for iteration
	 * @var string
	 */
	zend_declare_property_string(zend_stdlib_priorityqueue_ce, SL("queueClass"), "Zend\\Stdlib\\SplPriorityQueue", ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(zend_stdlib_priorityqueue_ce, SL("items"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * Inner queue object
	 * @var SplPriorityQueue
	 */
	zend_declare_property_null(zend_stdlib_priorityqueue_ce, SL("queue"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_class_constant_long(zend_stdlib_priorityqueue_ce, SL("EXTR_DATA"), 1 TSRMLS_CC);

	zend_declare_class_constant_long(zend_stdlib_priorityqueue_ce, SL("EXTR_PRIORITY"), 2 TSRMLS_CC);

	zend_declare_class_constant_long(zend_stdlib_priorityqueue_ce, SL("EXTR_BOTH"), 3 TSRMLS_CC);

	zend_class_implements(zend_stdlib_priorityqueue_ce TSRMLS_CC, 1, spl_ce_Countable);
	zend_class_implements(zend_stdlib_priorityqueue_ce TSRMLS_CC, 1, zend_ce_aggregate);
	zend_class_implements(zend_stdlib_priorityqueue_ce TSRMLS_CC, 1, zend_ce_serializable);
	return SUCCESS;
 ...
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, insert) {
 ...
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, remove) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zend/stdlib/priorityqueue.zep", 105);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		zephir_array_fetch_string(&_4, item, SL("data"), PH_NOISY | PH_READONLY, "zend/stdlib/priorityqueue.zep", 99 TSRMLS_CC);
	...
	if (found) {
		...
		if (!(zephir_is_true(_6))) {
			...
			zephir_is_iterable(_8, &_10, &_9, 0, 0, "zend/stdlib/priorityqueue.zep", 117);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_10, &_9)
				...
				zephir_array_fetch_string(&data, item, SL("data"), PH_NOISY, "zend/stdlib/priorityqueue.zep", 112 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(priority);
				zephir_array_fetch_string(&priority, item, SL("priority"), PH_NOISY, "zend/stdlib/priorityqueue.zep", 113 TSRMLS_CC);
 ...
 * @return bool
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, isEmpty) {
 ...
 * @return int
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, count) {
 ...
 * @return mixed
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, top) {
 ...
 * @return mixed
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, extract) {
 ...
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, getIterator) {
 ...
 * @return string
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, serialize) {
 ...
 * @return void
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, unserialize) {
	...
	zephir_check_call_status();
	zephir_is_iterable(unserialized, &_2, &_1, 0, 0, "zend/stdlib/priorityqueue.zep", 228);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		...
		zephir_array_fetch_string(&datum, item, SL("data"), PH_NOISY, "zend/stdlib/priorityqueue.zep", 223 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(priority);
		zephir_array_fetch_string(&priority, item, SL("priority"), PH_NOISY, "zend/stdlib/priorityqueue.zep", 224 TSRMLS_CC);
 ...
 * @return array
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, toArray) {
...
PHP_METHOD(Zend_Stdlib_PriorityQueue, toDataArray) {
	...
	zephir_array_fetch_string(&_0, item, SL("data"), PH_NOISY | PH_READONLY, "zend/stdlib/priorityqueue.zep", 269 TSRMLS_CC);
	RETURN_CTORW(_0);

}

PHP_METHOD(Zend_Stdlib_PriorityQueue, toPriorityArray) {
	...
	zephir_array_fetch_string(&_0, item, SL("priority"), PH_NOISY | PH_READONLY, "zend/stdlib/priorityqueue.zep", 274 TSRMLS_CC);
	RETURN_CTORW(_0);
 ...
 * @return PriorityQueue
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, setInternalQueueClass) {
 ...
 * @return bool
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, contains) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zend/stdlib/priorityqueue.zep", 307);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		ZEPHIR_GET_HVALUE(item, _3);
		zephir_array_fetch_string(&_4, item, SL("data"), PH_NOISY | PH_READONLY, "zend/stdlib/priorityqueue.zep", 303 TSRMLS_CC);
		if (ZEPHIR_IS_IDENTICAL(_4, datum)) {
			RETURN_MM_BOOL(1);
		}
	}
 ...
 * @return bool
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, hasPriority) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zend/stdlib/priorityqueue.zep", 325);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		ZEPHIR_GET_HVALUE(item, _3);
		zephir_array_fetch_string(&_4, item, SL("priority"), PH_NOISY | PH_READONLY, "zend/stdlib/priorityqueue.zep", 321 TSRMLS_CC);
 ...
 * @return SplPriorityQueue
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, getQueue) {
	...
	if (Z_TYPE_P(_0) == IS_NULL) {
		...
		if (unlikely(!(zephir_instance_of_ev(queue, spl_ce_SplPriorityQueue TSRMLS_CC)))) {
			...
			ZEPHIR_INIT_VAR(_5);
			object_init_ex(_5, zend_stdlib_exception_domainexception_ce);
			ZEPHIR_CALL_METHOD(NULL, _5, "__construct", NULL, exceptionMsg);
			zephir_check_call_status();
			zephir_throw_exception_debug(_5, "zend/stdlib/priorityqueue.zep", 346 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
 ...
 * @return void
 */
PHP_METHOD(Zend_Stdlib_PriorityQueue, __clone) {
...
PHP_METHOD(Zend_Stdlib_PriorityQueue, __construct) {
