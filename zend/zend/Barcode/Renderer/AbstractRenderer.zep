...
abstract class AbstractRenderer implements RendererInterface
{
    ...
    public function __construct(options = null)
    {
        ...
        let this->type = strtolower(substr(
            get_class(this),
     ...
     * @return AbstractRenderer
     */
    public function setRendererNamespace(_namespace)
    {
        let this->rendererNamespace = _namespace;
        return this;
    }
    ...
    public function setTopOffset(value)
    {
        ...
        let this->topOffset = intval(value);
        return this;
    }
    ...
    public function setLeftOffset(value)
    {
        ...
        let this->leftOffset = intval(value);
        return this;
    }
    ...
    {
        let this->automaticRenderError = (bool) value;
        return this;
    }
    ...
    public function setHorizontalPosition(value)
    {
        ...
        let this->horizontalPosition = value;
        return this;
    }
    ...
    public function setVerticalPosition(value)
    {
        ...
        let this->verticalPosition = value;
        return this;
    }
    ...
    public function setModuleSize(value)
    {
        ...
        let this->moduleSize = floatval(value);
        return this;
    }
    ...
    {
        let barcodeHeight = this->barcode->getHeight(true) * this->moduleSize;
        if barcodeHeight != supportHeight && this->topOffset == 0 {
            switch this->verticalPosition {
                case 'middle':
                    let this->topOffset = floor(
                            (supportHeight - barcodeHeight) / 2);
                    break;
                case 'bottom':
                    let this->topOffset = supportHeight - barcodeHeight;
                    break;
                case 'top':
                default:
                    let this->topOffset = 0;
                    break;
            }
        }

        let barcodeWidth = this->barcode->getWidth(true) * this->moduleSize;

        if barcodeWidth != supportWidth && this->leftOffset == 0 {
            switch this->horizontalPosition {
                case 'center':
                        let this->leftOffset = floor(
                            (supportWidth - barcodeWidth) / 2);
                    break;
                case 'right':
                        let this->leftOffset = supportWidth - barcodeWidth;
                    break;
                case 'left':
                default:
                        let this->leftOffset = 0;
                    break;
            }
        }
    }
    ...
    public function draw()
    {
        try {
            ...
            if this->automaticRenderError && !(e instanceof BarcodeException\RendererCreationException) {
                let barcode = Barcode::makeBarcode(
                    'error',
                    ['text' => e->getMessage()]
                );
                this->setBarcode(barcode);
                let this->resource = null;
                this->initRenderer();
                this->drawInstructionList();
            } else {
                throw e;
    ...
    {
        let instructionList = this->barcode->draw();
